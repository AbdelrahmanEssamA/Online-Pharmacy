 ...
 * @author Abdelrahman
 */
public class AssignOrdertoDelivery extends javax.swing.JFrame {

    /**
     * Creates new form AssignOrdertoDelivery
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Assign to Delivery");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if(this.jTextField1.getText().isEmpty() || this.jTextField2.getText().isEmpty() ){
          JOptionPane.showMessageDialog(null,"Invalid inputs","Inane error",JOptionPane.ERROR_MESSAGE);
       }
       else
            JOptionPane.showMessageDialog(null,"Order was assigned");
